      ...
      <DialogContent className="max-w-3xl">
        <DialogHeader>
          <DialogTitle className="text-xl font-bold">
            Histórico de Transações - {clientName}
          </DialogTitle>
        </DialogHeader>
        ...
        <div className="flex justify-between items-center mb-4">
          ...
          >
            {selectedDebts.length === transactions.length ? "Desmarcar Todos" : "Selecionar Todos"}
          </Button>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="text-sm text-muted-foreground">
                      {format(new Date(transaction.created_at), "dd 'de' MMMM", { locale: ptBR })}
                    </p>
